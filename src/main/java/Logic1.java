...
public class Logic1
{
    ...
    if(isAsleep == true){
      ...
      else if(isMom == true && isAsleep == false && isMorning == true){
          return true;
      }
      else {
          return false;
    ...
    public int teaParty(int tea, int candy) {
      if(tea>=5 && candy >=5 && tea <= 10 && candy <=10){
          return 1;
      }
